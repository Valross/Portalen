...
<div class="col-sm-5">
	<form action="" method="post">
	    ...
	    <p><input type="text" placeholder="Mobilnummer" name="phone_number" maxlength="15" /></p>
		...
		<p><textarea rows="4" cols="50" placeholder="Beskrivning" name="description" maxlength="150"></textarea></p>
