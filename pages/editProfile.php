...
<div class="col-sm-5">
	<form action="" method="post">
	  ...
	  <p>Personnummer: <input type="text" placeholder="<?php echo $profileSsn; ?>" name="ssn" maxlength="10" /></p>
		...
		<br/>
		<h3>Byta lösenord</h3>
		<p>Nuvarande lösenord: <input type="password" name="old_password" /></p>
		<p>Nytt lösenord: <input type="password" name="password" /></p>
		<p>Bekräfta lösenord: <input type="password" name="confirmed_password" /></p>
