...
<div class="row">
	<div class="col-sm-6">
		<div class="page-header">
			<h1><span class="fa fa-square-o fa-fw fa-lg"></span> Ocheckade pass
			</h1>
		</div>
	</div>
	<div class="col-sm-6 page-header-right">
		<div class="pull-right form-inline">
				<div class="btn-group">
					...
					<a href="?page=checkUncheckedPasses" class="btn btn-page-header active"><i class="fa fa-square-o fa-fw fa-lg"></i> Ocheckade pass</a>
